...
public class EqualsAndHashcodeTest {
    ...
    @Test
    public void equals_afterConsume() {
        Result<String, String> result = Result.success("Success");
    ...
    @Test
    public void equals_differentObjectsSameContent() {
        Result<String, String> result = Result.success("Success");
    ...
    @Test
    public void equals_differentObjectsDifferentContent() {
        Result<String, String> result = Result.success("Success");
    ...
    @Test
    public void equals_sameValueButSuccessAndError() {
    ...
    @Test
    public void equals_sameValueButDifferentResultClass() {
    ...
    @Test
    public void equals_nonResultClass() {
        Result<Boolean, String> result = Result.success(true);
        assertThat(result.equals("Test")).isFalse();
    }

    @Test
    public void hashCode_equalForSameValue() {
